...
class CodeArtConfig(PretrainedConfig):
    r"""
    ...
    def __init__(
        ...
        max_relative_position_embeddings=8,  # NOTE: codeart unique
        type_vocab_size=2,
        ...
        ep_add_linear_projection=False,     # NOTE: codeart unique
        **kwargs,
    ):
        ...
        self.max_relative_position_embeddings = max_relative_position_embeddings    # NOTE: codeart unique
        ...
        self.ep_add_linear_projection = ep_add_linear_projection    # NOTE: codeart unique