...
class RabertConfig(PretrainedConfig):
    r"""
    ...
    def __init__(
        ...
        ep_add_linear_projection=False,     # NOTE: rabert unique
        **kwargs,
    ):
        ...
        self.ep_add_linear_projection = ep_add_linear_projection    # NOTE: rabert unique