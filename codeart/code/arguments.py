...
class ModelArguments:
    ...
    ep_add_linear_projection: bool = field(
        default=False,
        metadata={
            "help": (
                "Whether to add a linear projection before computing dot product for edge prediction"
            )
        }
    )
    ...
    max_transitions: Optional[int] = field(
        default=None,
        metadata={
            "help": ("Maximum number of transitions to consider in masking")
        }
    )
...
class DataTrainingArguments:
    ...
    ep_probability: float = field(
        default=0.15, metadata={"help": "Ratio of <INST> nodes to select for edge prediction loss"}
    )
